  ...
  for(int i =0; i < students.length; i++){
   for (int j = 0; j < students[i].length; j++ ){
    if(searchStr.equals(students[i][j])){
     ...
     System.out.println("Job: "+students[i][1]);
     System.out.println("City: "+students[i][2]);
     System.out.println("Zip Code: "+students[i][3]);
     System.out.println("Start Date: "+students[i][4]);
     System.out.println("Salary: "+students[i][5]);
	 System.out.println();
